      ...
      <div className='mb-3'>
        <form>
          ...
          <input
            type="text"
            name="location"
            className="w-full h-50 px-4 py-3 bg-white rounded-lg border border-neutral-400 text-base font-medium font-['Nunito'] my-1"
            placeholder="Enter the first location where the event would take place"
            required
            id="event_location"
            value={data.location}
