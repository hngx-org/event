  ...
  return (
    <div className="w-max h-max px-14 py-12 rounded-2xl bg-[#FEFEFE] flex flex-col gap-8 justify-center items-center">
      ...
      <div className="max-w-[345px] flex flex-col gap-6 items-center">
        <MessageQuestionSVG />
        <p className="text-base text-center text-grey-100 font-semibold font-sans">
          {message}
        </p>
        <div className="flex justify-center items-center gap-6">
          <button
            onClick={onclose}
            className="py-[18px] px-6 text-secondary-300  font-bold bg-transparent border border-secondary-300 rounded-lg text-center flex items-center justify-center gap-2"
            type="button"
          >
            <BackArrowSVG />
            <span>Go Back</span>
