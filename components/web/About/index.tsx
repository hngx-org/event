...
const About = () => {
  return (
    <>
      <div className='flex flex-col justify-center items-center px-5 py-20 mx-auto relative w-full max-w-7xl '>
        ...
        <Image
          src={VectorImg}
          alt='vector_img'
          className='absolute h-[200px] w-8 left-0 hidden lg:block'
        />
      </div>

      <div className='px-5  w-full h-full flex flex-col justify-center items-center lg:flex-row mt-10 max-w-7xl mx-auto'>
