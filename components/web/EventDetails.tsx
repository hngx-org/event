    ...
    return (
        <>
            <div className="max-w-7xl mx-auto flex justify-between mb-6 mt-24">
                ...
                <Link href='/Checkout' className="bg-[#800000] text-white text-base font-bold flex justify-center items-center py-[18px] px-8 rounded-lg">Register for this event</Link>
            </div>
