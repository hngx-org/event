...
const HeroSection = () => {
  return (
    <div
      className="h-[93vh] w-full 2xl:xl:max-w-7xl mx-auto flex flex-col gap-y-5 md:gap-x-4 lg:gap-x-1 md:flex-row items-center justify-center md:justify-normal px-5 lg:px-20"
      style={{
        background:
