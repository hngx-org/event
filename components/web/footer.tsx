        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-36 mb-12">
          ...
          <div className="lg:max-w-sm">
            ...
            <p className="text-grey-100">
              We set out to redefine event experiences. What started as a
              passion project soon evolved into a full-fledged entity, and our
              journey has been marked by collaborations, and challenges.
            </p>
          </div>
