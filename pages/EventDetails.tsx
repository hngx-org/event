...
import ArrowBackIcon from "@/components/icons/EventDetails/arrowback";
import Footer from "@/components/web/footer";
import Header from "@/components/web/header";
import React from "react";
import Image from "next/image";
import ElipseIcon from "@/components/icons/EventDetails/Elipse";
import OptionIcon from "@/components/icons/EventDetails/Option";
...
export default function EventDetails () {
    return (
        <>
            ...
            <div className="max-w-7xl mx-auto flex justify-between mb-6 mt-8">
                <div className="flex gap-4 items-center">
                    <ArrowBackIcon />
                    <h3 className="text-[#3B3B3B] text-2xl font-bold">Tech Innovators Summit</h3>
                </div>
                <button className="bg-[#800000] text-white text-base font-bold flex justify-center items-center py-[18px] px-8 rounded-lg">Register for this event</button>
            </div>
            ...
            <div className="max-w-7xl mx-auto mt-8">
                <div className="flex justify-between">
                    <div className="flex flex-col gap-8">
                        <div className="flex flex-col gap-6 max-w-[733px]">
                            <h1 className="text-[#3B3B3B] text-2xl font-bold">Event Description</h1>
                        ...
                        <div className="flex flex-col gap-6">
                            <h1 className="text-[#3B3B3B] text-2xl font-bold">Event Tags</h1>
                            <div className="flex flex-wrap gap-x-8 gap-y-4 max-w-[653px]">
                                <span className="flex py-2 px-3 justify-center gap-1 rounded-lg border border-[#3B3B3B]">Technology</span>
                                <span className="flex py-2 px-3 justify-center gap-1 rounded-lg border border-[#3B3B3B]">AI</span>
                                <span className="flex py-2 px-3 justify-center gap-1 rounded-lg border border-[#3B3B3B]">Workshops</span>
                                <span className="flex py-2 px-3 justify-center gap-1 rounded-lg border border-[#3B3B3B]">Networking</span>
                                <span className="flex py-2 px-3 justify-center gap-1 rounded-lg border border-[#3B3B3B]">Innovation</span>
                                <span className="flex py-2 px-3 justify-center gap-1 rounded-lg border border-[#3B3B3B]">About me</span>
                                <span className="flex py-2 px-3 justify-center gap-1 rounded-lg border border-[#3B3B3B]">About me</span>
                            </div>
                        </div>
                    </div>
                    <div className="inline-flex p-6 items-start gap-6 rounded-2xl bg-[#FAFAFA] max-w-[437px] max-h-[252px]">
                        <div className="flex flex-col gap-6">
                            <div>
                                <div className="flex justify-between">
                                <h1 className="text-[#800000] font-bold text-xl">08-10 October, 2023</h1>
                                <h1 className="text-[#1C1C1C] font-bold text-xl">&#8358;20,000</h1>
                                </div>
                            </div>
                            <div className="flex flex-col gap-4">
                                <div className="flex gap-2 items-start">
                                    <LocationIcon />
                                    <h4 className="text-[#1C1C1C] text-base font-semibold">
                ...
                <div className="flex flex-col gap-3 mt-[72px] mb-28">
                    <h1 className="text-[#3B3B3B] text-2xl font-bold">Similar Event</h1>
