        ...
        <div className="max-w-[605px] w-full text-center">
          ...
          <div className="max-w-[398px] mx-auto">
            ...
            <p className="text-[#757575] mt-6 text-base font-semibold font-sans">
              Congratulations! Answer a few questions to customize your event
              timeline and make it uniquely yours
            </p>
            <button
              onClick={() => router.push(`/timeline`)}
              className="w-full mt-6 mx-auto p-[18px] text-center text-white bg-secondary-300 rounded-lg text-base font-bold active:scale-[0.99] font-sans"
            >
              Proceed
            </button>
          </div>
