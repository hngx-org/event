        ...
        <div className="mt-8 px-[20px] md:px-[40px] gap-8 flex items-center justify-between">
          ...
          <div className="flex gap-6 items-center">
            <button
              ...
              type="button"
              className="px-8 py-[18px] rounded-lg bg-transparent text-secondary-300 border border-secondary-300 font-bold active:scale-[0.99]"
            >
              Delete Event
            </button>
            <button
          ...
          <div className="flex flex-col lg:flex-row gap-10 justify-between">
            ...
            <div className="max-w-[733px] w-full">
              ...
              <div className="max-w-[650px] w-full flex gap-4 justify-between mt-8">
                <div>
                  <h1 className="font-montserrat font-bold text-2xl text-[#3B3B3B]">
                    Available Tickets
                  </h1>
