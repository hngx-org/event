...
const Modal: React.FC<{ isOpen: boolean, onClose: () => void }> = ({ isOpen, onClose }) => {
  ...
  return isOpen ? (
    <div className='fixed top-0 left-0 flex items-center justify-center w-full h-full bg-gray-800 bg-opacity-50'>   
      <div className="modal text-center md:w-3/4 lg:w-1/2 w-full">
         <div className="modal-content bg-white p-4 items-center rounded-2xl modal mx-4 md:mx-auto">
           {getComponentByIndex(currentComponent)}
           <button className='w-full md:w-96 px-4 md:px-20 mt-2 py-4 bg-red-900 rounded-lg' onClick={onClose}>
           <div className=" text-white text-base font-bold font-['Nunito'] leading-none xs:text-sm">
              Go Back to Timeline
            </div>
           </button>
         </div>
...
//       case 5:
//         return (
//           <Component5 onBack={handleBack} onProceed={handleProceed} />
//         );
//       default:
//         return null;
//     }
