            ...
            <div className="mt-7 px-8 sm:px-12 md:px-16 lg:px-20">
              ...
              <div className="flex gap-3 my-8">
                <button
                  ...
                  onClick={() => setToggleCreatEvent(true)}
                >
                  Created Event
                </button>
                <button
                  className="text-[#3B3B3B] text-sm"
                  onClick={() => setToggleCreatEvent((prev) => !prev)}
                >
                  Registered Event
                </button>
              </div>
              <div className="w-90 sm:w-1/4 mx-auto my-10 text-left sm:text-center py-3 sm:py-1">
                ...
                <p className="text-[#2E2E2E] text-sm">
                  Get started by creating you first event! 'Click the Create' An
                  Event button to create your next great experience
                </p>
              </div>
            </div>
          </EventManagement>
            ...
            <EventManagement>
              <div className="mt-7 px-8 sm:px-12 md:px-16 lg:px-20">
                ...
                <div className="flex gap-5 flex-wrap my-4 sm:justify-between">
                  ...
                  <div
                    className="w-64 bg-[#F2E6E6] border border-solid border-1 border-[#CB9696] rounded flex flex-col justify-center items-center py-4 cursor-pointer"
                    onClick={handleRegisteredEvent}
                  >
                    <p className="text-lg text-[#800000] font-bold">0</p>
                    <p>Registered Events</p>
                  </div>
                ...
                <div className="flex gap-3 my-8">
                  <button className="text-[#3B3B3B] text-sm">
                    Created Event
                  </button>
                  <button className="text-[#800000] font-bold underline">
                    Registered Event
                  </button>
                </div>
                <div className="w-90 sm:w-1/4 mx-auto my-10 text-left sm:text-center py-3 sm:py-1">
                  ...
                  <p className="text-[#2E2E2E] text-sm">
                    ...
                    <span className="text-[#800000] font-bold underline">
                      Explore
                    </span>{" "}
